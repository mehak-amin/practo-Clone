...
const Faq = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "The privacy of our patients is critical to us, and thus, we are compliant with all regulations to ensure data protection and confidentiality.",
    },
    {
      question: "What happens if I don’t get a response from a doctor?",
      answer:
        "In the unlikely event that an online doctor does not respond, you will receive a full refund if the issue is not resolved within the stipulated time.",
    },
    {
      question: "Can I do a free online doctor consultation on Practo?",
      answer:
        "Avail a free online consultation with top doctors in India during specific promotional periods or through special offers provided by Practo.",
    },
  ];
  ...
  return (
    <div id="FaqSection">
      <div
        className="homepage-section-wrapper desktop-wrapper faq-section"
            ...
            {faqData.map((faq, index) => (
              <section className="grid__col-sm-12 grid__col-md-6" key={index}>
                ...
                <div
                  ...
                  className="u-spacer__5x each-accordion"
                >
                  
                  <h3 className="accordion-text">
                    <span
                      className="chevron-icon"
                      onClick={() => toggleExpansion(index)}
                      style={{ cursor: "pointer" }}
                    >
                      {expanded === index ? <HiChevronDown /> : <HiChevronRight /> }
                    </span>
                    {faq.question}
                  </h3>
