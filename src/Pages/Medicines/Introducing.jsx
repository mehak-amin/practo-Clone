    ...
    <div>
      <div className="Introducing-container">
        ...
        <div className="Introducing-column right-column">
          ...
          <p className='left-text'>INTRODUCING FAST DELIVERY</p>
          <h3 className='second-left-text'>Tired of waiting in a queue? Too weak to go down and buy medicines?</h3>
          <img src='/logo/mar-card-2.5a0b85e1.png' className='oneImage' alt="Fast Delivery" />
        </div>
      </div>
